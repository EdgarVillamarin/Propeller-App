...
with siteHeader:
  ...
  st.text('''Dear network, the aim of this project is make available open-water characteristics
  for ship propeller design and selection, for a wide range of propllers series in this web app
  At the moment, the classic B-series are available here. I hope for the future to upgrade the
  app with other propeller serieshence, if you have other propeller series data availble,
